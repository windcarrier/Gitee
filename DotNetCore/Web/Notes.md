...
![WebValidationPic](NotesSrc/Pic/form_in_design_view.jpg)
...
**ActiveX Data Objects** 提供了前端控件和后端数据库之间的桥梁。ADO.NET 对象封装了与数据显示对象相互作用的所有的数据存取操作和控件。因此便隐藏了数据移动的细节。

下列图表整体展示了 ADO.NET 对象：

![ADO.NET Object](NotesSrc/Pic/ado.net_objects.jpg)
